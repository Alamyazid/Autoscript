...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Alamyazid/Autoscript/main/nginx.conf"
...
wget -O menu "https://raw.githubusercontent.com/Alamyazid/Autoscript/main/menu.sh"
